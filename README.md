...
<img src="images/clipboard-1472973958.png" width="189" />

# mlwdw (MLW Data Wrangling 2026)

Welcome to the R package mlwdw – a new tool for organizing the data
...
You can install the current version of mlwdw by executing this in R:
    ...
    remotes::install_github("ATSzimmat/mlwdw")
    library(mlwdw)
